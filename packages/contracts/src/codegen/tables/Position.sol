...
library Position {
  ...
  function getX(IStore _store, address owner) internal view returns (int32 x) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((owner))));
  ...
  function setX(IStore _store, address owner, int32 x) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((owner))));
  ...
  function getY(IStore _store, address owner) internal view returns (int32 y) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((owner))));
  ...
  function setY(IStore _store, address owner, int32 y) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((owner))));
  ...
  /** Get the full data */
  function get(address owner) internal view returns (PositionData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((owner))));
  ...
  function get(IStore _store, address owner) internal view returns (PositionData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((owner))));
  ...
  function set(address owner, int32 x, int32 y) internal {
  ...
  function set(IStore _store, address owner, int32 x, int32 y) internal {
    bytes memory _data = encode(x, y);
  ...
  function set(address owner, PositionData memory _table) internal {
    set(owner, _table.x, _table.y);
  }

  /** Set the full data using the data struct (using the specified store) */
  function set(IStore _store, address owner, PositionData memory _table) internal {
    set(_store, owner, _table.x, _table.y);
  }
