...
library Player {
  ...
  /** Get value */
  function get(address owner) internal view returns (bool value) {
  ...
  function get(IStore _store, address owner) internal view returns (bool value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((owner))));
  ...
  /** Set value */
  function set(address owner, bool value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((owner))));
  ...
  function set(IStore _store, address owner, bool value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((owner))));
